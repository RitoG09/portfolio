---
title: "CollabDraw"
description: "A real-time collaborative drawing application supporting multiple users with live canvas synchronization and real time chatting."
...
# CollabDraw: A real-time collaborative drawing application

## Overview

CollabDraw is a modern notes sharing platform that allows users to read notes, give quizzes, revise from flashcards, execute code snippets, and also have PYQs, more.
