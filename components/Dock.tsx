...
export default function Dock({
  ...
  return (
    <motion.div
      style={{
        height: floating ? height : undefined,
        scrollbarWidth: "none",
      }}
      ...
      <motion.div
        ...
        className={`${className} ${
          floating
            ...
            : "relative"
        } flex items-end w-fit gap-4 rounded-2xl border-gray-200 dark:border-neutral-700 border-2 pb-2 px-4`}
